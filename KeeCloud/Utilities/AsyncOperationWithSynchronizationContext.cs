...
namespace KeeCloud.Utilities
{
    ...
    /// </remarks>
    class AsyncOperationWithSynchronizationContext
    {
        ...
        public AsyncOperationWithSynchronizationContext(Action asyncAction, Action continuation, Action<Exception> catchAction, Action finallyAction)
        {
